                ...
                >
                    <template #header>
                        ...
                        >
                            ...
                            <div
                                class="flex flex-column gap-1 md:flex-row md:justify-content-between md:align-items-center"
                            >
                    ...
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <Button
                                ...
                                @click="goToPreviewStok(slotProps.data)"
                            />
                        </template>
                    </Column>
                </DataTable>
                ...
                >
                    <div class="grid">
                        <div class="grid col-12 md:col-6">
                            <div class="field col-8">
                                <label for="categoryPick">Pilih Kategori</label
                                ><Badge
                    ...
                    <div class="formgrid grid">
                        ...
                        <div class="field col-12 md:col-4">
                            ...
                            <InputText id="satuan" v-model="product.satuan" />
                        </div>
                    </div>
                    <template #footer>
                        <Button
...
export default {
    ...
    methods: {
                    ...
                    footer: () => {
                        return [
                            ...
                            h(Button, {
                                ...
                                icon: "pi pi-check",
                                onClick: () =>
                                    dialogRef.close({ buttonType: "Yes" }),
                                autofocus: true,
                            }),
                        ];
                    },
        ...
        refreshCategory(cat = "none") {
            this.productService.getBarangCategory().then((data) => {
                ...
                let category_pick =
                    cat == "none" ? this.categories.category[0].value : cat;
                this.productService
                    .getBarangByCategory(category_pick)
                    .then((data) => {
        ...
        scanNOW(mode) {
            ...
            if (
                ...
                if (mode == "search") this.searchBarcode = true;
                else this.searchBarcode = false;
                this.barcodeDialog = true;
                console.log("yes");
            } else {
                console.log("no");
        ...
        onDecodeBarcode(e) {
            ...
            if (this.searchBarcode) {
                // alert(e)
                // this.filters["global"].value = e;
                let dataProduct = this.products.filter((item) => {
                    return item.barcode == e;
                });

                if (dataProduct.length) {
                    this.goToPreviewStok(dataProduct[0]);
                } else
                    alert(
                        "Kemungkinan stok kosong.. Silakan coba yang lain atau input stok masuk dulu."
                    );
            } else {
        ...
        goToPreviewStok(data) {
            console.log(data);
            useStore().previewstok = data;
            this.$router.push({ path: `/preview/stok/rincian/${data.id}` });
        },
    },
};
</script>
